...
const AllProjects = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch("http://localhost:3000/api/v1/project/searchProject", {
        method: 'POST',
        headers: new Headers({
  ...
  return (
    <>
      ...
      <div className="main-content">
          ...
          <div className="search mb-4" ref={searchRef}>
                  ...
                  <div className="card card-background" style={{ height: '275px' }}>
                    ...
                    <div className="card-body d-flex flex-column" >
                      ...
                      <p className="card-text mb-4">
                        <span className="projectText">Budget: </span><span style={{color:'#6C7172'}}>{project.budget}</span>
                      </p>
                      <p className="card-text mb-4">

...
const ForgetPasswordFormCompany = () => {
    ...
    const handleForgetPassword = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:3000/api/v1/Company/forgetpassword', {
                method: 'POST',
                headers: {
    ...
    const handleOTPVerification = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://localhost:3000/api/v1/Company/resetpassword', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    try {
        const response = await fetch('http://localhost:3000/api/v1/Company/setnewpassword', {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
                ...
                <div className='container container-bg'>
                    ...
                    <form onSubmit={showOTPField ? (showResetPasswordFields ? handleResetPassword : handleOTPVerification) : handleForgetPassword}>
                        ...
                        <div className='doesnt-have-account'>
                            ...
                            <Link to='/login' className='create-account-text'> Sign in </Link>
                        </div>
                    </form>
                </div>
            </div>
...
export default ForgetPasswordFormCompany;

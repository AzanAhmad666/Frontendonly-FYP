  ...
  const [cookies, setCookie] = useCookies(["userType"]);
    ...
    return(
        <div className='nav heading'>
            ...
            <Link to='/CompanyHome' style={{fontSize:18, paddingTop:3, textDecoration:'none', color:'white'}}>Meetings</Link>
            </div>
            ...
            <Link to='/CompanyHome' style={{fontSize:18, paddingTop:3, textDecoration:'none', color:'white'}}>Analytics</Link>
            </div>
            ...
            >
                ...
                <Link to='/CompanyHome' style={{fontSize:18, paddingTop:3, textDecoration:'none', color:'white'}}>Settings</Link>
            </div>
              </>
            )}
